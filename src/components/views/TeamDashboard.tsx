        ...
        <div className="team-dashboard container">
          ...
          <div className="team-dashboard grid">
            <TeamDashboardSessionBox startRow={1} startColumn={1} endRow={2} endColumn={2}>
              <StatusComponent sessionStatus={sessionStatus} setSessionStatus={setSessionStatus}
                               goalMinutes={goalMinutes} setGoalMinutes={setGoalMinutes} startDateTime={startDateTime}
                               setStartDateTime={setStartDateTime} totalTime={totalTime} setTotalTime={setTotalTime} />
