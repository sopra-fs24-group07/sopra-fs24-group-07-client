  ...
  const overviewTutorial = location.pathname === "/teams";
    ...
    return (
        ...
        {overviewTutorial ? (
            ...
            <h3>Create Team</h3>
            <p>Click on the Create Team button to create your first team! After setting a team name, you can either write your own description, or click on the orange wand button to automatically generate a team description.</p>
            </div>
        ) : (
            <div>
            ...
            <h3>Voice Chat</h3>
            <p>You can join the VoiceChat by clicking on one of the channels. You will always have a main channels, and all the other channels are the breakout rooms of the active tasks. 
            You can always mute yourself by clicking on the mute button.</p>
            <h3>Sessions History</h3>
            <p>Click on the Session History Button to get a list of your session stats.</p>
            <h3>Comments</h3>
            <p>By clicking on the task inside the Kanban board, you can add comments for the specific task.</p>
